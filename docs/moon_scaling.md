...
`moon` always applies scaling in A/B, targeting, and structural estimation.
The unscaled implementation and dispatch option have been removed. The tables
above document historical comparisons; new runs use the scaled algorithm only.
